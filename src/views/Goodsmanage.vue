 ...
 * @license: MIT
 * @lastAuthor: Candy
 * @lastEditTime: 2021-08-13 16:31 PM
    ...
    <div class="top">
      <div class="goodsquery">
        ...
        <div class="goodsq_rieht" @click="exit">
          ...
          >
            <path
              d="M511.96 766.27L67 257.73h890L511.96 766.27z"
              p-id="5619"
              fill="#707070"
            ></path>
          </svg>
        ...
        <div class="formmenu">
            ...
            <form>
              ...
              >
                ...
                <el-form-item label="商品详情:">
                  <el-button type="primary" @click="textclick"
                    >使用富文本</el-button
                  >
          ...
          <div class="skudatas">
                ...
                <div v-for="(item, index) in list" :key="index">
                  <h4>
                    ...
                    <el-input
                      ...
                      style="width: 200px"
                    ></el-input>
                    <el-button type="primary" @click="addValue(index)"
                      >添加值</el-button
                    >
                  </h4>
                  <div
            ...
            <div class="container" style="text-align: center">
              ...
              <el-button type="primary" @click="addspuTitle"
                >添加规格</el-button
              >
