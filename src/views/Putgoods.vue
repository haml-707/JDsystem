 ...
 * @license: MIT
 * @lastAuthor: Candy
 * @lastEditTime: 2021-08-13 16:28 PM
 * @desc: 商品上架
-->
<template>
  <div>
      ...
      <div class="skudatas">
        <div id="app">
          <div class="container" style="text-align: center">
            <span>sku:</span>
            <el-input v-model="titel" placeholder="请输入规格" style="width: 300px"></el-input>
        ...
        <div class="container" style="text-align: center">
          <span>spu:</span>
          <el-input v-model="sputitel" placeholder="请输入规格" style="width: 300px"></el-input>
    ...
    <div class="skudata" v-show="spushow">
      <div class="spupublic">
        <div v-for="(item, index) in spuitems" :key="index" class="spuitem">
          <div
            class="gspu"
            v-for="(itemss, key) in spuidata"
            :key="key"
          >{{ itemss }}：{{ item[itemss] }}</div>库存：
          <el-input v-model="item.stock" type="number" placeholder="请输入库存" style="width: 200px"></el-input>价格：
